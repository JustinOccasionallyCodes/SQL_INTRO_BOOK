...
INSERT INTO supervisor_salaries (town, county, supervisor, salary, benefits)
SELECT town, 'Some County', supervisor,'2020-03-01', salary, 1000
...
TO 'C:\practical-sql-main\Chapter_04\us_counties_latlon_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');
...
COPY movies(id, actor_name, movie_name) 
TO 'C:\practical-sql-main\Chapter_04\movies.txt'
WITH (FORMAT CSV, HEADER, DELIMITER ':', QUOTE '#');

INSERT INTO movies( actor_name, movie_name) 
SELECT 'Tom Cruise','Mission: Impossible';
FROM movies;
-------------------------------------------------------------------
...
TO 'C:\practical-sql-main\Chapter_04\test_youself_2.txt'
WITH (FORMAT CSV, HEADER);